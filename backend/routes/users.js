    ...
    if(err){
      ...
      user.save((err,user)=>{
        ...
        const msg = {
          ...
          html: '<strong>Please click on the following link to verify your email!!</strong><a href="http://localhost:5000/verifyemail/'+req.body.username+'/'+token+'">Click Here!!</a>',
        }
